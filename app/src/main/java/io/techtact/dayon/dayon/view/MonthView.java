package io.techtact.dayon.dayon.view;
...
import io.techtact.dayon.dayon.R;
import io.techtact.dayon.dayon.util.CalendarUtils;
import io.techtact.dayon.dayon.view.decoration.CircleSpan;
import io.techtact.dayon.dayon.view.decoration.UnderDotSpan;
...
public class MonthView extends RecyclerView{
    ...
    static class GridAdapter extends Adapter<GridAdapter.CellViewHolder> {
        ...
        public GridAdapter(long monthMillis) {
            ...
            //getShortWeekdays 0th position is empty
        ...
        //Determinie view type with numbers 0-7 week header, others week days
        @Override
            ...
            switch (viewType) {
                case VIEW_TYPE_HEADER:
                    return new HeaderViewHolder(inflater.inflate(
                            R.layout.mv_grid_item_header, parent, false));
                case VIEW_TYPE_CONTENT:
                default:
                    return new ContentViewHolder(inflater.inflate(
                            R.layout.mv_grid_item_content, parent, false));
            }
        }

        // default index is 1=> sun, 2=>mon, 3=>tue, 4=>wed 5=>thu, 6=>fri, 7=>sat
        @Override
